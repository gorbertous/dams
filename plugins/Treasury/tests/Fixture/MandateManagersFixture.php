...
/**
 * MandateManagersFixture
 */
class MandateManagersFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'length' => 128, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
