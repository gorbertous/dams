	...
	<?php echo $this->Form->create('Rating', array('data-id'=>$id)) ?>
		...
		<?php
			echo $this->Form->input('bs_date', array(
					...
					'default'	=> UniformLib::uniform($row['Rating']['bs_date'],'bs_date')
				)
			);
		?>
		</div>
		...
		<?php
			echo $this->Form->input('LT-MDY_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['LT-MDY_date'], 'LT-MDY_date')
				)
			);
		?>
		<?php
		...
		<?php
			echo $this->Form->input('LT-FIT_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['LT-FIT_date'], 'LT-FIT_date')
				)
			);
		?>
		<?php
		...
		<?php
			echo $this->Form->input('LT-STP_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['LT-STP_date'], 'LT-STP_date')
				)
			);
		?>
		<?php
		...
		<?php
			echo $this->Form->input('LT-EIB_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['LT-EIB_date'], 'LT-EIB_date')
				)
			);
		?>
		</div>
		...
		<?php
			echo $this->Form->input('ST-MDY_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['ST-MDY_date'], 'ST-MDY_date')
				)
			);
		?>
		<?php
		...
		<?php
			echo $this->Form->input('ST-FIT_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['ST-FIT_date'], 'ST-FIT_date')
				)
			);
		?>
		<?php
		...
		<?php
			echo $this->Form->input('ST-STP_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['ST-STP_date'], 'ST-STP_date')
				)
			);
		?>
		<?php
		...
		<?php
			echo $this->Form->input('ST-EIB_date', array(
					...
					'div'		=> 'span4',
					'data-date-format'	=> 'dd/mm/yyyy',
					'default'	=> UniformLib::uniform($row['Rating']['ST-EIB_date'], 'ST-EIB_date')
				)
			);
		?>
		<?php
