		...
		<tbody>
			<?php foreach($rows as $key=>$row): ?>
				<tr>
					...
					<td><?php print UniformLib::uniform($row['Mandate']['created'], 'created') ?></td>
					<td><?php print UniformLib::uniform($row['Mandate']['modified'], 'modified') ?></td>
					<td class="actions">
						<?php
						print $this->Html->link(
						    '<i class="icon-pencil"></i>',
						    'mandate/'.$row['Mandate']['mandate_ID'],
