<fieldset>
	<legend>REV-IN-OUT Booking Report <small>From <?php echo $start_date ?> To <?php echo $end_date ?></small></legend>
	...
	<p><a href="/treasury/treasuryaccruals/revinout_pdf/<?php echo $transaction_id ?>/<?php echo $start_date ?>/<?php echo $end_date ?>">Click here to download the PDF file</a></p>
</fieldset>