	...
	<div class = "well span5">
		...
		<?php if(isset($fromReinv)): ?>
			<div class="alert alert-info">
				...
				<?php echo $fromReinv; ?>
	<?php
	echo $this->Form->input('Transaction.pool', array(
		'type' => 'hidden',
		'label'	=> false,
		'div'	=> false,
		'value'	=> $pool,
...
<?php endif ?>
				...
				<tr>
					<td>
						...
						echo $this->Form->input('Transaction.depo_renew', array(
							...
							'div'	=> false,
							'value'	=> 'Yes',
							'checked'	=> ($defaultOpts['depo_renew'] == 'Yes'),
					...
					<td>
						...
						echo $this->Form->input('Transaction.depo_renew', array(
							...
							'div'	=> false,
							'value'	=> 'No',
							'checked'	=> ($defaultOpts['depo_renew'] == 'No'),
		...
		if($trnIsSet){
			...
			echo $this->Form->input('Transaction.modified', array(
				'type' => 'hidden',
				'label'	=> false,
				'div'	=> false,
