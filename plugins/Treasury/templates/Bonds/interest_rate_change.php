...
function validate_form()
{
	...
	var rate = $("#updateInterestRateNewRate").val();
	var transactions = $("#transactions input:checked");
	...
	element.disabled = !(rate && transactions);
...
$(document).ready(function () {
	...
	$('#updateInterestRateValueDate').datepicker({  format: "yyyy-mm-dd" });
