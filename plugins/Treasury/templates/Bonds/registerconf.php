...
<script type="text/javascript">
	...
	function refreshTotalInterest(){
		$.getJSON('/treasury/treasuryajax/calcTotalInterest?', $("#TransactionRegisterconfForm").serialize(), function(data) {
	...
	function refreshTaxAmount(){
		$.getJSON('/treasury/treasuryajax/computeTax?', $("#TransactionRegisterconfForm").serialize(), function(data)
		{
