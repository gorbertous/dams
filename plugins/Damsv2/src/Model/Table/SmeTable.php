 ...
 * @property \App\Model\Table\PortfolioLogHistoryTable&\Cake\ORM\Association\BelongsToMany $PortfolioLogHistory
 *
 * @method \App\Model\Entity\Sme newEmptyEntity()
 * @method \App\Model\Entity\Sme newEntity(array $data, array $options = [])
 * @method \App\Model\Entity\Sme[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Sme get($primaryKey, $options = [])
 * @method \App\Model\Entity\Sme findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \App\Model\Entity\Sme patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Sme[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \App\Model\Entity\Sme|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Sme saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Sme[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\Sme[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\Sme[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\Sme[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class SmeTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('Damsv2.SmePortfolio', [
            'foreignKey' => 'sme_id',
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ->integer('sme_id')
            ->allowEmptyString('sme_id', null, 'create');
