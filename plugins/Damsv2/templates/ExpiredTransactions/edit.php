...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $expiredTransaction->expired_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $expiredTransaction->expired_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="expiredTransactions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Expired Transaction') ?></legend>
                <?php
