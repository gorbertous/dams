...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $mappingTable->table_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $mappingTable->table_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="mappingTable form content">
            ...
            <fieldset>
                <legend><?= __('Edit Mapping Table') ?></legend>
                <?php
