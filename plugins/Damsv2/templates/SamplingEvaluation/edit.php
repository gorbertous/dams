...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $samplingEvaluation->evaluation_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $samplingEvaluation->evaluation_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="samplingEvaluation form content">
            ...
            <fieldset>
                <legend><?= __('Edit Sampling Evaluation') ?></legend>
                <?php
