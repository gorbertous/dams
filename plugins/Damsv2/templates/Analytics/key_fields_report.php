...
$this->Breadcrumbs->add([
    ...
    [
        'title'   => 'DAMS Key Fields Data Extract',
        'url'     => ['controller' => 'analytics', 'action' => 'key-fields-report'],
        'options' => ['class' => 'breadcrumb-item']
    ],
]);
?>
<h3>DAMS Key Fields Data Extract</h3>
<hr>
<div class="row">
    <div class="col-9">
        <?php if(!empty($msg)) :  ?>
        ...
        <div class="row col-6 form-inline">
			...
			<?= $this->Html->link('Cancel', ['action' => 'data-extracts-reports'], ['class' => 'btn btn-danger form-control my-3']) ?>
        </div>
        <?= $this->Form->end() ?>
    </div>
</div>
