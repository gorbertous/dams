...
$this->Breadcrumbs->add([
   ...
   [
    ...
    [
        'title'   => 'Country\'s Mandates Performance Report',
        'url'     => ['controller' => 'Analytics', 'action' => 'mandate-performance-country'],
        'options' => ['class' => 'breadcrumb-item']
    ],
]);
?>
<h3>Country's Mandates Performance Report</h3>
<hr>
<div class="row">
    <div class="col-9">
        <?php if(!empty($msg)) :  ?>
        ...
        <?= $this->Form->create(null, ['id' => 'FiltersForm']); ?>
            <div class="form-group row form-inline">
                <label class="col-sm-2 col-form-label required" for="Report.country">Country</label>
                <div class="col-6">
                  <?= $this->Form->select('Report.country', $countries, [
