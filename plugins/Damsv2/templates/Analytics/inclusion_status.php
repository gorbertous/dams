...
$this->Breadcrumbs->add([
    ...
    [
        'title'   => 'Inclusion Status Report',
        'url'     => ['controller' => 'Analytics', 'action' => 'inclusion-status'],
        'options' => ['class' => 'breadcrumb-item']
    ],
]);
?>
<h3>Inclusion Status Report</h3>
<hr>
<div class="row">
    <div class="col-9">
        <?php if(!empty($msg)) :  ?>
        ...
        <div class="row col-6 form-inline">
			...
			<?= $this->Html->link('Cancel', ['action' => 'operations-reports'], ['class' => 'btn btn-danger form-control my-3']) ?>
        </div>
        <?= $this->Form->end() ?>
    </div>
</div>
