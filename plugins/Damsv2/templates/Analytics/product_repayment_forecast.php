...
$this->Breadcrumbs->add([
    ...
    [
        'title'   => 'Loan Product Repayment Forecast',
        'url'     => ['controller' => 'Report', 'action' => 'product-repayment-forecast'],
        'options' => ['class' => 'breadcrumb-item']
    ],
]);
?>
<h3>Loan Product Repayment Forecast</h3>
<hr>
<div class="row">
    <div class="col-9">
        <?php if(!empty($msg)) :  ?>
        ...
        <?= $this->Form->create(null, ['id' => 'FiltersForm']); ?>
			...
			<p>The result will be based on data from the selected inclusion period end.</p>
            <div class="form-group row form-inline">
			...
			<p>The start of the maturity time periods will be counted as from the selected balance sheet date.</p>
