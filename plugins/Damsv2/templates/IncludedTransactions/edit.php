...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $includedTransaction->included_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $includedTransaction->included_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="includedTransactions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Included Transaction') ?></legend>
                <?php
