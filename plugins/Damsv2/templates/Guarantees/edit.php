...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $guarantee->guarantee_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $guarantee->guarantee_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="guarantees form content">
            ...
            <fieldset>
                <legend><?= __('Edit Guarantee') ?></legend>
                <?php
