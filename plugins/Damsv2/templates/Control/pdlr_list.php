        ...
        <tbody>
            <?php foreach ($reports as $report): ?>
                ...
                <tr>
                    ...
                    <td>
                        <?= $this->Form->postLink('<i class="fas fa-trash-alt"></i>' , ['action' => 'delete-pdlr-report', $report->report_id],['escape' => false, 'title' => __('Delete'), 'class' => 'btn btn-danger btn-xs'], ['confirm' => __('Are you sure you want to delete # {0}?', $report->report_id)]) ?>
