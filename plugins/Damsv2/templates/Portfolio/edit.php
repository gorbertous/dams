...
$this->Breadcrumbs->add([
        ...
        [
            'title' => 'Edit - '.$portfolio->deal_name, 
            'url' => ['controller' => 'Portfolio', 'action' => 'edit', $portfolio->portfolio_id],
            'options' => [
...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $portfolio->portfolio_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $portfolio->portfolio_id), 'class' => 'side-nav-item']
            ) ?>
