...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $smePortfolio->sme_portfolio_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $smePortfolio->sme_portfolio_id), 'class' => 'side-nav-item']
            ) ?>
            <?= $this->Html->link(__('List Sme Portfolio'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="smePortfolio form content">
            <?= $this->Form->create($smePortfolio) ?>
            <fieldset>
                <legend><?= __('Edit Sme Portfolio') ?></legend>
                <?php
