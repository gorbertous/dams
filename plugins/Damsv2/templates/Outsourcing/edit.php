...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $outsourcingLog->log_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $outsourcingLog->log_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="outsourcingLog form content">
            ...
            <fieldset>
                <legend><?= __('Edit Outsourcing Log') ?></legend>
                <?php
