...
$this->Breadcrumbs->add([
    ...
    [
        ...
        'url'     => ['controller' => 'validation', 'action' => 'inclusion-notice-reason-ro'],
        'options' => [
            'class'      => 'breadcrumb-item active',
            'innerAttrs' => [
                'class' => 'test-list-class',
...
<div class="row">
    <div class="col-6 form-inline">
        <?= $this->Form->Html->link('Back', ['action' => 'validation-report-ro', $report->report_id], ['class' => 'btn btn-secondary mr-2']) ?>
