...
class PortfoliosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fi_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'portfolios_ibfk_1' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['products', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'fi_name' => 'Lorem ipsum dolor sit amet',
                'created' => '2021-10-08 17:56:10',
                'modified' => '2021-10-08 17:56:10',
            ],
        ];
        parent::init();
    }
