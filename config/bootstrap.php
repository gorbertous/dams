...
Configure::write('Auth.AuthenticationComponent.load', true);
...
/*
 * Load an development configuration file to provide overrides to your configuration.
 * Notice: For security reasons development.php **should not** be included in your git repo.
 */
if (file_exists(CONFIG . 'development.php')) {
    Configure::load('development', 'default');
}
